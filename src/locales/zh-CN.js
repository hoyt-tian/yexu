export default {
  ...
  'menu.home': '首页',
  'menu.shops': '店铺管理',
  'menu.shops.amazon': 'Amazon',
  'menu.shops.ebay': 'Ebay',
  'menu.shops.wish': 'Wish(尚未开放)',
  'menu.dashboard': '数据大盘',
  'menu.dashboard.analysis': '统计数据',
  'menu.dashboard.monitor': '仓储数据',
  ...
  'menu.product': '产品管理',
  'menu.product.search': '查找产品',
  'menu.product.add': '添加产品',
  'menu.order': '订单管理',
  'menu.order.sync': '订单同步',
  'menu.order.search': '订单查询',
  'menu.warehouse': '跨境仓库',
  'menu.warehouse.index': '入库管理',
  ...
  'app.analysis.sales-ranking': '销售额排名',
  ...
  'app.analysis.online-top-search': '关键词分析',
  'app.analysis.the-proportion-of-sales': '销售额类别占比',
  'app.analysis.channel.all': '全部渠道',
  'app.analysis.channel.online': 'Amazon',
  'app.analysis.channel.stores': 'Ebay',
  ...
  'app.monitor.trading-activity': '跨境仓储总览',
  'app.monitor.total-transactions': '总存量',
  'app.monitor.sales-target': '货物损耗率',
  'app.monitor.remaining-time': '平均周转日期',
  'app.monitor.total-transactions-per-second': '配送投诉次数',
  'app.monitor.activity-forecast': '活动情况预测',
  'app.monitor.efficiency': '质量监控',
  'app.monitor.ratio': '良品率',
  ...
  'app.monitor.resource-surplus': '仓容利用率',
  'app.monitor.fund-surplus': '当前占用',
